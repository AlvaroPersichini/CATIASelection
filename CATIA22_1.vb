...
Module CATIA2
    ...
    Public Class CatiaSession
        ...
        Private Function Connect() As INFITF.Application
            Try
                ' Intenta obtener una instancia ACTIVA de CATIA
                Return CType(GetObject(, "CATIA.Application"), INFITF.Application)

            Catch ex As System.Runtime.InteropServices.COMException
                ' Significa que CATIA NO está abierto
                ' (error típico: 0x800401E3: Operation unavailable)
                Return Nothing

            Catch ex As Exception
                ' Cualquier otro tipo de error inesperado
                Console.WriteLine("Error conectando a CATIA: " & ex.Message)
                Return Nothing
            End Try
        End Function
        ...
        ' ✅ Referencia a la aplicación CATIA
        ...
        ' ✅ Saber si está lista para trabajar (documento válido abierto)
